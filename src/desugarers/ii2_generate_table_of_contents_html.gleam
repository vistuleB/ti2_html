...
fn at_root(root: VXML, inner: InnerParam) -> Result(VXML, DesugaringError) {
  ...
  let toc = V(desugarer_blame(45), toc_tag, [], [chapters_div])
...
fn chapter_link(
  ...
  let a =
    V(item_blame, "a", [Attr(desugarer_blame(125), "href", link)], [
  ...
  let style_attr =
    Attr(desugarer_blame(136), "style", "margin-left: " <> margin_left)
...
fn div_with_id_title_and_menu_items(
  ...
  V(desugarer_blame(149), "div", [Attr(desugarer_blame(149), "id", id)], [
    V(
      desugarer_blame(151),
      "ul",
      [Attr(desugarer_blame(153), "style", "list-style: none")],
      menu_items,
    ),
  ])
}
